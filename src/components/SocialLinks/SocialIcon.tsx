type SocialIconName = "calendar" | "tiktok" | "instagram" | "whatsapp" | "map" | "like";

export default function SocialIcon({ name }: { name: SocialIconName }) {
  if (name === "like") return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 10v11H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3Z" /><path d="M7 20h9.7a2 2 0 0 0 1.9-1.4l2.1-7A2 2 0 0 0 18.8 9H14l.7-3.2A2.3 2.3 0 0 0 12.4 3L7 10Z" /></svg>;
